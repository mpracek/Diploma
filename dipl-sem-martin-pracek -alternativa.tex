...
Model, ki ga bom uporabil, ima diskretna stanja. Velja torej, da nam model pove le, v katerm stanju se nahajamo. Za svoj portfelj sem želel ugotoviti prehode med stanji markovskih verig, ki se skrivajo za signali, ki jih prikazujejo cene ob koncu trgovalnih dni. Donose sem podobno kot v \cite{prvivir} definiral glede na volatilnost v tistem obdobju. Nato sem jih grupiral v tri razlièna fiksna stanja.Dobil sem normalno stanje, ki velja v $70\%$ èasa, stanje visoke volatilnosti, ki velja $20\%$ èasa ter ekstremno stanje, ki velja preostalih $10\%$ èasa, podobno kot velja v viru \cite{AustrianALMO}. Zaporedje stanj sem doloèil prek volatilnosti portfelja, in sicer sem stanja doloèil glede na relativen odmik. Za vsak trenutek sem poiskal relativno rast cene portfelja in jih razvrstil v èasovno vrsto. Za te cene sem poiskal ustrezne percentile, prek katerih sem opazovanja pravilno grupiral.\\
...
\end{verbatim}\\  
Prehodna matrika je rezultat, ki ga lahko pridobimo, ko poznamo zaporedje stanj.\\
%\begin{figure}[h!]
%	\begin{center} 
...
\begin{table}[h!]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		Normalna  & 0.4723262 &  0.3829033 & 0.1447705 \\ \hline
		Visoka    & 0.4173430  & 0.3923537 & 0.1903033 \\ \hline
		Ekstremna & 0.3137170  & 0.3898745 & 0.2964085 \\ \hline
	\end{tabular}
\end{table}
