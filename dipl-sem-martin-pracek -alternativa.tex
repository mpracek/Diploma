...
V moji diplomski nalogi sem se ukvarjal s skritimi markovskimi modeli. Gre za vrsto markovskega modela, kjer ne poznamo stanj, v katerih se model nahaja. Ta stanja so torej skrita, od koder tudi izhaja ime skriti markovski modeli. V svojem delu sem opisal osnove teorije skritih markovskih modelov ter nekaj primerov uporabe. Posebej sem se posvetil skritim markovskim modelom opisanimi z Gaussovimi mešanicami. Posvetil sem se tudi èasovnim vrstam in nekaj njihovim posebnim lastnostim. Obenem pa sem opisal še praktièni primer, kjer pokažem kako izraèunamo prehodno matriko.\\
\vfill
\begin{center}
