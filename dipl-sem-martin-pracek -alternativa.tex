...
Zahteva o merljivosti prostora pomeni, da ima množico $S$ podmnožico $\mathcal{S}$, ki zadošèa pogojem za obstoj $\sigma$-algebre. Potem je par  $(S,\mathcal{S})$ merljiv prostor.\\
...
Skriti markovski modeli uporabljajo idejo bayesianske statistike. Tu uporabljamo Bayesov izrek \ref{bayes}, ki pravi, da je verjetnost dogodka $A$, v primeru da $B$ velja enaka:
...
\begin{figure}[h!]
	...
	\end{center} 
\end{figure}  
 Te lahko še lažje prikažemo na manjšem obsegu. Primer na sliki $7$ pa prikazuje stanja v koncu leta $2008$, kjer opazimo veèje število primerov v stanju ekstremne volatilnosti, kar ne preseneèa. 
% 
% \begin{figure}[h!]
% 	\label{cetrtek}
% 	\begin{center} 
