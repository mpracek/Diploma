...
Model, ki ga bomo uporabili, ima diskretna stanja. Velja torej, da nam model pove le, v katerm stanju se nahajamo. Èe bi želeli izvesti primer, prikazan v \ref{trening} in \ref{zacetno}, bi morali poleg prehodne matrike doloèiti še celoten preostal nabor $\lambda$. V našem primeru pa nas le zanimajo prehodi med skritimi stanji, zato tega ne potrebujemo. Sicer bi, kot opisano v \ref{generator}, glede na zaporedje opazovanj doloèili vse paratmetre s pomoèjo predhodno opisanih postopkov. Najprej bi tako izbrali primerno število stanj in mešanic, izbrali primerno zaèetno oceno za podatke, nato pa izvedli trening.\\
Za svoj portfelj sem želel ugotoviti prehode med stanji markovskih verig, ki se skrivajo za signali, ki jih prikazujejo cene ob koncu trgovalnih dni. Ta stanja sem podobno kot v \cite{prvivir} definiral glede na volatilnost donosa v tistem obdobju na tri razlièna stanja, poleg tega pa so ta stanja fiksna. Tako smo dobili normalno stanje, ki velja v $70\%$ èasa, stanje visoke volatilnosti, ki velja $20\%$ èasa ter ekstremno stanje, ki velja preostalih $10\%$ èasa, podobno kot velja v viru \cite{AustrianALMO}. Zaporedje stanj sem doloèil prek volatilnosti portfelja, in sicer sem stanja doloèil glede na relativen odmik. Za vsak trenutek sem poiskal relativno rast cene portfelja in jih razvrstil v èasovno vrsto. Za te cene sem poiskal ustrezne percentile, prek katerih sem opazovanja pravilno grupiral.\\
...
Iz zaporedja stanj pridobimo prehodno matriko. Za oceno le te smo si pomagali z predhodno implementiranimi R funkcijami, prek katerih smo izraèunali oceno zanjo. Prehodna matrika je rezultat, ki ga lahko pridobimo, ko poznamo zaporedje stanj.\\
\begin{figure}[h!]
	\begin{center} 
...
\begin{figure}[h!]
	\begin{center} 
		\includegraphics[scale=0.8]{slike/prehodna_slika}\\
...
\begin{figure}[h!]
	\label{sreda}
	\begin{center} 
		\includegraphics[scale=0.8]{slike/leto}\\
		\caption{Stanja ob koncu leta $2008$}
	\end{center} 
\end{figure}  
 Te lahko še lažje prikažemo na manjšem obsegu. Primer na sliki $8$ pa prikazuje stanja v koncu leta $2008$, kjer opazimo veèje število primerov v stanju ekstremne volatilnosti, kar ne preseneèa. Po drugi strani pa to dejstvo nakazuje na to, da ta proces ni èasovno homogen, saj verjetnosti prehodov niso enake kot v ostalih obdobjih.\\
% 
% \begin{figure}[h!]
% 	\label{cetrtek}
% 	\begin{center} 
