...
\begin{primer}
	...
	Za le te velja, da vseh parametrov ne poznamo, lahko pa jih doloèimo iz podatkov, ki jih imamo za naš problem. Tako bi našo žabo dovolj dolgo opazovali, in si zapisovali na primer njeno temperaturo v vsakem trenutku opazovanja. Tako bi dobili vektor opazovanj $O$, ki bi vseboval temperaturo žabe v vsakem trenutku. V pomoèjo skritih markovskih modelov bi nato poizkušali doloèiti v kakšnem stanju, torej na kakšni poziciji se je nahajala v vsakem trenutku. Doloèitev zaporedja stanj je se razlikuje med primeri. V primeru žabe bi tako lahko pogledali spremembo temperature ob spremembi stanja, ter glede na to spremembo poizkušali doloèiti, kje se žabica nahaja.\\
	Vektor $O$ je naš osnovni podatek, iz katerega nato izpeljemo celoten model, torej poišèemo zaporedje skritih stanj in nato verjetnosti prehodov med njimi. Za  Iz tega bi najprej pogledali, kakšna so možna stanja sistema. Ko bi doloèili stanja ter njihovo zaporedje, iz tega lahko doloèimo parametre modela. Kako to naredimo, si bomo pogledali v nadaljevanju, na primeru prehodne matrike pa poglejmo, kaj le ta pomeni. \\
	...
	Kot smo prej omenili, pa se ta matrika spremeni, èe žabo osvetlimo. Tako lahko dobimo matriko, ki govori o verjetnostih prehodov, èe na sistem vplivamo.
	$$
	\begin{bmatrix}
	0.9 & 0.05 & 0.05  \\
	0.4 & 0.5 & 0.1  \\
...
Model, ki ga bomo uporabili je model z diskretnimi stanji. Velja torej, da nam model pove le, v katerm stanju se nahajamo. Èe bi želeli izvesti primer, prikazan v \ref{trening} in \ref{zacetno}, bi morali poleg prehodne matrike doloèiti še celoten preostal nabor $\lambda$. V našem primeru pa nas le zanimajo prehodi med skritimi stanji, zato tega ne potrebujemo. Sicer bi, kot opisano v \ref{generator}, glede na zaporedje opazovanj doloèili vse paratmetre s pomoèjo predhodno opisanih postopkov. Najprej bi tako izbrali primerno število stanj in mešanic, izbrali primerno zaèetno oceno za podatke, nato pa izvedli trening.\\
Za svoj portfelj sem želel ugotoviti prehode med markovskimi verigami, ki se skrivajo za signali, ki jih prikazujejo cene ob koncu trgovalnih dni. Ta stanja sem podobno kot v \cite{prvivir} definiral glede na volatilnost donosa v tistem obdobju na tri razlièna stanja. Tako smo dobili normalno stanje, ki velja v $70\%$ èasa, stanje visoke volatilnosti, ki velja $20\%$ èasa ter ekstremno stanje, ki velja preostalih $10\%$ èasa, podobno kot velja v viru \cite{AustrianALMO}. Zaporedje stanj sem doloèil prek volatilnosti portfelja, in sicer sem stanja doloèil glede na relativen odmik. Tako sem doloèil skrita stanja.\\
...
%%Popravi izraèunano prehodno matriko z oceno matrike iz Matlab paketa!!!
%%Nujen popravek
\begin{table}[h!]
