...
\begin{frame}
\begin{itemize}
\item Sluèajni proces $Q$, ki predstavlja signale
...
\item Podatki $O$
\item Število stanj
\item Število mešanic
\end{itemize}
\end{frame}

\begin{frame}
\frametitle{Maksimizacija $P(O|\lambda)$}
\begin{itemize}
	\item Zaèetni nabor $\lambda$
	\item $P(O|\lambda_i) \geq P(O|\lambda_{i+1})$
\end{itemize}
\end{frame}
...
\begin{frame}
\frametitle{Primer ocenjevanja prehodnih verjetnosti}
\begin{figure} 
	\begin{center}  
