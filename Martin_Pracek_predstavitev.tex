...
\frametitle{ $C$, $\Sigma$ in $\Gamma$}
 Za dobro zaèetno oceno si lahko pomagamo z šopom $k$-povpreèij.
 Za $C$ to pomeni, da bo element $c_{ij}$ $=$ $1/k$ za vsak par $ij$, kjer je $k$ število šopov povpreèij. Prièakovane vrednosti in variance nato pridobimo iz vrednosti teh šopov povpreèij.
 \ \\
...
\includegraphics[scale=0.25, center]{slike/gore}
\end{frame}
