...
Za uèinkovit izraèun le teh delamo $naprej - nazaj$.
...
\includegraphics[scale=0.25]{slike/treningmodela}
\end{frame}

\begin{frame}
\frametitle{Trening modela}
Da bomo lahko $P(O|\lambda)$ sploh izraèunali, potrebujemo zaèetne ocene parametrov. 
\end{frame}
