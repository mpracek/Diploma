...
\begin{titlepage}
	\begin{center}
		...
		\Large
		Diplomski seminar - kratka predstavitev
		
		\vspace{0.5cm}
		\LARGE
		\textbf{Skriti markovski modeli v èasovnih vrstah}
...
\begin{enumerate}
	...
	\item Matrike $\Gamma$, $\mu_{ij}$ predstavlja prièakovano vrednost mešanice $j$ v stanju $i$
	\item $\Sigma$, kjer $\sigma_{ij}$ predstavlja varianco mešanice $j$ v stanju $i$
	\item $C$, koeficienti $c_{ij}$ iz Gaussove mešanice
\end{enumerate}
\end{frame}
