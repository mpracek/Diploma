...
Že v \ref{zahteva} sem omenil, da so finanèni donosi navadno "left-skewed", torej je mediana manjša od povpreèja. Prav zato naj bi bili skriti markovski modeli, po \ref{prvivir} bolj prirejeni za ugotavljanje padajoèih cen finanènih instrumentov. To bom preveril na veèih setih podatkov. Moj praktièni primer bom razdelil na veè razliènih delov. \\
