...
\begin{table}[h]
	\begin{tabular}{|c|c|c|}
		...
		\hline
		Kontorliran                   & Markovski proces odloèanja      & Delno opazoval proces odloèanja
		\show \hline
	\end{tabular}
\end{table}
...
Glavna ideja uporabe skritih markovskih modelov v finanèni èasovni sledi iz osnovne ideje Andrewa Viterbija, in sicer analiziranje signalov, ki jih prejmemo tako, da izloèimo šume v prejetem signalu.
