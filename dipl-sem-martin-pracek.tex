...
Ko imamo sedaj za seboj celotno teorijo potrebno za razumevanje skritih markovskih modelov, poglejmo še celotni algoritem skritih markovskih modelov.
\begin{algorithm}[h!]
	\caption{Skriti markovski model} \label{hmm}
	\KwResult{Najbolj verjetno zaporedje opazovanj $X=(x_1,x_2,\ldots,x_N)$}
	Input:
	\begin{itemize}
		\item Zaporedje opazovanj $O$
	\end{itemize}
\end{algorithm}
