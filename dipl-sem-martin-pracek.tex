...
Zamislimo si, da imamo ribnik z lokvanji, v katerem so se naselile žabe. Vsaka izmed žab je lahko v vsakem trenutku v vodi, na lokvanju ali pa zunaj vode. To imenujemo stanja markovskega modela. Poimenujmo vektor stanj  $$S = (Voda,Lokvanj,Zemlja) = (1,2,3) $$ Na ribnik pogledamo le v nekih diskretnih èasih, z enakim razmikom, na primer ob koncu vsake minute. Odloèimo se za opazovanje le ene izmed žab. V našem primeru nas zanima, kje se bo nahajala ena, èe vemo kje se nahaja druga. Druga žaba je za nas viden proces, zanima pa nas, pot, po kateri bo prišla prva žaba do svoje konène pozicije. \\
...
Na drugi strani pa imamo avtonomen model, kjer lahko loèimo èe je proces v celoti opazen ali so neka stanja skrita. 
\pagebreak
