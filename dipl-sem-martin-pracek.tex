...
\begin{enumerate}
	\item Èasovne vrste v zveznih èasih. Tu pridobivamo podatke za vsak trenutek znotraj nekega èasovnega intervala. Dober primer je tu EKG, torej elektrokardiogram. Problem teh èasovnih vrst je, da jih dejansko ne moremo shraniti v celoti, saj bi morali v konèno velikost pomnilnika shraniti neskonèno mnogo vrednosti iz (naèeloma) realnih števil $\mathbb{R}$, ki imajo lahko tudi sama neskonèen decimalni zapis. Zato naèeloma uporabljamo približke teh vrst.
