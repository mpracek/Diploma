...
Natanèneji pregled razkriva, da je na obmoèju, na katerem smo model uèili navadno prihajalo do rasti. Le v treh primerih je namreè prišlo do padca cene napram prejšnjemu povpreèju, v $916$ primerih je prišlo do rasti cene, nikoli pa nismo imeli stagnacije.\\
\includegraphics[scale=0.65]{slike/prehodna_stanja}\\
To lahko vidimo tudi iz grafa prehodov, kjer $3$ pomeni rast, $2$ stagnacijo in $1$ padec.
