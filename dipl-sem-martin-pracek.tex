...
Iz tega sledi, da je $P(O|\lambda) = \sum_{i=1}^{N}{\alpha_{T}(i)}$
\\
Na enak naèin izraèunamo tudi $\beta_{t}(i)$, ki ni nujen za izraèun  $P(O|\lambda)$, vendar ga nujno rabimo za trening našega modela.
\linebreak
