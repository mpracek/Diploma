...
\includegraphics[scale=0.65]{slike/tesla}\\
...
\includegraphics[scale=0.65]{slike/prehodi}\\
Natanèneji pregled razkriva, da je na obmoèju, na katerem smo model uèili navadno prihajalo do rasti. Le v $25$ primerih je namreè prišlo do padca cene napram prejšnjemu povpreèju, v $894$ primerih je prišlo do rasti cene, nikoli pa nismo imeli stagnacije.\\
\includegraphics[scale=0.8]{slike/prehodna_stanja}\\
...
Naravno se nam postavi vprašanje, 
\includegraphics[scale=0.65]{slike/simulirano}
\includegraphics[scale=0.65]{slike/razlike_stanj}
