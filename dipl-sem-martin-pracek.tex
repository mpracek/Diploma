...
\begin{figure}[!h]
	...
	\begin{minipage}[t]{4cm}
		\centering
		\includegraphics[scale=0.5]{slike/celota}
		\caption{Cena èez celotno obdobje}
	\end{minipage}
	\begin{minipage}[t]{4cm}
		\centering
		\includegraphics[scale=0.5]{slike/polovica}
		\caption{Cena èez polovico obdobja}
	\end{minipage}
\end{figure}
%\begin{figure}%
%	\centering
...
Za vsako izmed teh podjetij bom izbral dve obdobji, vsako dolgo $100$ dni ter na njiju izvedel trening modela. 
