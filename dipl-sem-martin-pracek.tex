...
\begin{table}[h]
	\begin{tabular}{lllll}
		...
		\multicolumn{1}{|l|}{Avtonomen}   & \multicolumn{1}{l|}{Markovska} & \multicolumn{1}{l|}{Skriti} & markovski & model    \\ \cline{1-3}
		\multicolumn{1}{|l|}{Kontorliran} & \multicolumn{1}{l|}{Markovski} & \multicolumn{1}{l|}{Delno}  & opazovan  & proces   \\ \cline{1-3}
		&                                &                             &           &         
	\end{tabular}
\end{table}
