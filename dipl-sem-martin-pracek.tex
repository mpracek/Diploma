...
\begin{table}[h!]
	\begin{tabular}{lllll}
		\cline{1-3}
		\multicolumn{1}{|l|}{}            & \multicolumn{1}{l|}{V celoti opazovan}         & \multicolumn{1}{l|}{Le delno opazovan} \\ \cline{1-3}
		\multicolumn{1}{|l|}{Avtonomen}   & \multicolumn{1}{l|}{Markovska veriga} & \multicolumn{1}{l|}{Skriti markovski model}    \\ \cline{1-3}
		\multicolumn{1}{|l|}{Kontorliran} & \multicolumn{1}{l|}{Markovski proces odloèanja} & \multicolumn{1}{l|}{Delno opazovan proces}   \\ \cline{1-3}
		&                                &                             &           &         
	\end{tabular}
\end{table}
\begin{table}[h]
	\begin{tabular}{|c|c|c|}
		...
		\hline
		Kontorliran                   & Markovski proces odloèanja      & Delno opazovan proces odloèanja
		\show \hline
	\end{tabular}
\end{table}
