...
\geslo{Prièakovan primankljaj}{Naj bo $X$ donos portfelja nekoè v prihodnosti in naj velja da je $0<\alpha<1$, kjer je $\alpha$ stopnja zaupanja. Prièakovan primankljaj $ES_\alpha$ je definiran kot $$ES_\alpha = -\frac{1}{\alpha}\int_{0}^{\alpha}{VaR_\gamma(x)d\gamma}$$kjer je $VaR_\gamma$ \textbf{Value at risk}. }  \\%Expected shortfall
...
\\
%Zakaj je markovska lastnost pomembna
