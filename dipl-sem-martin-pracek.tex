...
\begin{definicija}
Naj bo $(\Omega,\mathbb{F},\mathbb{P},\mathbb{F}_s)$ verjetnostni prostor s filtracijo za neko urejeno množico $I$. Naj bo $(S,\mathbb{S})$ merljiv prostor. $(S,\mathbb{S})$ merljiv sluèajni proces $X=\{X_t:\Omega \to S\}_{t\in I}$, ki je prilagojen na filtracijo, ima markovo lastnost, èe za vsak $A \in \mathbb{S}$ in vsak $s,t\in I$, kjer velja $s,t$ velja $$\mathbb{P}(X_t \in A \mid \mathbb{F}_s) = \mathbb{P}(X_t \in A\mid X_s)$$
