...
\definicija{Markovska lastnost} Naj velja, da imamo verjetnostni prostor s filtracijo $(\Omega,\( \mathcal{F} \),P,(\( \mathcal{F} \)_{n})_{n\geq1})$Naj bo $(X_n)_{n\geq1}$ zaporedje neodvisnih enako porazdeljenih sluèajnih spremenljivk ali vektorjev. Naj 
