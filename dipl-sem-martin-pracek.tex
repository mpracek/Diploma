...
\begin{enumerate}
\item[EM-algoritem] Algoritem maksimizacije prièakovanega (Expectation-maximization), ali krajše EM-algoritem so uporabljali med drugim že Laplace, Gauss in drugi, vendar je do dokonènega poimenovanja prišlo šele leta $1977$. Demster, Laird in Rubin so algoritem poimenovali in razložili splošno teorijo, ki deluje v ozadju procesa.
\item[Viterbi] Andrew Viterbi je drugi pomemben del skritih markovskih modelov implementiral leta $1967$ kot algoritem za dekodiranje konvolucij èez šume v komunikaciji. 
\item[Baum-Welch] Baum-Welchov algoritem je poseben primer posplošenega EM-algoritma. Algoritem sta razvila Leonard E. Baum ter Lloyd R. Welch ob koncu okrog leta $1970$. Ena izmed prvih aplikacij tega algoritma je bila v okvirju procesiranja govora.
\end{enumerate}
Celotnih modelov pa prav gotovo ne bi bilo brez še enega Rusa, in sicer Ruslana Leontijevièa Stratonovièa, ki je prvi opisal rekurzijo naprej - nazaj leta $1960$.\\
