...
Gre za problem iz stohastiènega programiranja, kjer nekateri parametri niso znani z gotovostjo, temveè jih predstavimo z nekim sluèajnim objektom, pa naj si bo to sluèajna spremenljivka za enoobdobne probleme oziroma sluèajni proces za veèobdobne probleme.\\
...
$$Var(Q_t) =\sum_{i=1}^{m}E(Q_t^2|S_t =i)P(S_t =i)-\sum_{i=1}^{m}E(Q_t|S_t =i)P(S_t =i).$$
...
Ko imamo vse to podano lahko izraèunamo avtokorelacijsko funkcijo, ki je cenilka korelacijskega koeficienta za naše podatke. Velja da je avtokorelacijska funkcija enaka 
...
\includegraphics[width=\linewidth,height=\linewidth]{slike/sinp}\\
