...
\item Andrew Viterbi je drugi pomemben del skritih markovskih modelov implementiral leta $1967$ kot algoritem za dekodiranje konvolucij èez šume v komunikaciji. 
\item Baum-Welchov algoritem je poseben primer posplošenega EM-algoritma. Algoritem sta razvila Leonard E. Baum ter Lloyd R. Welch ob koncu okrog leta $1970$. Ena izmed prvih aplikacij tega algoritma je bila v okvirju procesiranja govora.
\end{enumerate}
