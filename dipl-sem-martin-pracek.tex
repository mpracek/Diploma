...
\begin{definicija}{Markovska lastnost}
...
To definicijo lahko v diskretnem primeru še razširimo, èe velja še da je $I = \mathcal{N}$. Potem velja $$\mathbb{P}(X_n=x_n\mid X_{n-1}=x_{n-1}, \dots, X_0=x_0)=\mathbb{P}(X_n=x_n\mid X_{n-1}=x_{n-1})$$
