...
\definicija{Sluèajni proces} Za dan  ${\displaystyle (\Omega ,{\mathcal {F}},\mathbb {P} )}$ verjetnostni prostor z merljivim prostorom ${\displaystyle (S,\Sigma )}$, je sluèajni proces nabor sluèajnih spremenjlivk, ki ga lahko zapišemo kot $${\displaystyle \{X(t):t\in T\}}$$
...
\begin{table}[h!]
	\begin{tabular}{lcc}
		...
		Kontorliran                   & Markovski proces odloèanja      & Delno opazovalen maproces odloèanja
	\end{tabular}
\end{table}s
...
Vendar v moji diplomski nalogi ne bom govoril o Markovskih verigah, temveè o drugi vrsti avtonomnega markovskega procesa, in sicer o skritih markovskih modelih.
