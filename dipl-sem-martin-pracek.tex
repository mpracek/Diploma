...
Alternativni pristop pravi, da vzamemo stacionarne vrste, kjer gledamo le relativne razlike med cenami delnic. Tu uporabljamo princip stacionarnosti èasovnih vrst.\\
\begin{figure}[h!]
	\begin{center} 
...
\end{center} 
\end{figure}  
V tem primeru smo uporabili le odmik od cene prejšnjega dne za isto delnico.\\
...
Za svoj portfelj sem želel ugotoviti skrita stanja, ki se skrivajo za signali, ki jih prikazujejo cene ob koncu trgovalnih dni. Ta stanja sem podobno kot v \cite{prvivir} loèil glede na volatilnost donosa v tistem obdobju na tri razlièna stanja. Tako smo dobili normalno stanje, ki velja v $70\%$ èasa, stanje visoke volatilnosti, ki velja $20\%$ èasa ter ekstremno stanje, ki velja preostalih $10\%$ èasa, podobno kot velja v viru \cite{AustrianALMO}.\\
Ko je vprašanje števila stanj odgovorjeno potrebujemo še pravilno število mešanic. Z upoštevanjem Akakijevega informacijskega kriterija se izkaže, da je optimalno število mešanic za ta primer enako $2$.\\
Ko smo to doloèili smo lahko dobili še naslednje podatke.
\begin{figure}[h!]
	\begin{center} 
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		Normalna  & 0.65 & 0.30 & 0.05 \\ \hline
		Visoka    & 0.37 & 0.44 & 0.19 \\ \hline
		Ekstremna & 0.11 & 0.40 & 0.49 \\ \hline
	\end{tabular}
\end{table}

\begin{table}[]
	\caption{Vektor zaèetnih verjetnosti $\pi$}
	\begin{tabular}{|c|c|c|}
		\hline
		Normalna  & Visoka    & Ekstremna \\ \hline
		0.63 & 0.27 & 0.10 \\ \hline
	\end{tabular}
\end{table}

%\begin{table}[]
%	\caption{Matrika koeficientov mešanic C}
%	\begin{tabular}{|l|l|l|}
%		\hline
%		\multicolumn{1}{|c|}{}         & \multicolumn{1}{c|}{Prva} & \multicolumn{1}{c|}{Druga} \\ \hline
%		\multicolumn{1}{|c|}{Normalna} & \multicolumn{1}{c|}{0.76} & \multicolumn{1}{c|}{0.24}  \\ \hline
%		Visoka                         & 0.39                      & 0.61                       \\ \hline
%		Ekstremna                      & 0.30                      & 0.70                       \\ \hline
%	\end{tabular}
%\end{table}
Tako smo pridobili nekatere potrebne podatke za generiranje skritih markovskih modelov.
\pagebreak
\section{Zakljuèek}
