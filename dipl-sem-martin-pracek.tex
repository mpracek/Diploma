...
\begin{enumerate}
	...
	\item V vsakem izmed èasov $i$ ne vemo, v kakšnem stanju se nahajamo, vemo le, kakšni so rezultati našega procesa v tem èasu. Zato potrebujemo dodatni sluèajni proces \verb|{|{$q_{t}$\verb|}|$_{t = 1,2, \ldots}
\end{enumerate}
