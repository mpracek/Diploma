...
Na ta naèin smo pokazali Baum-Welchov algoritem, ki je osnova delovanja skritih markovskih modelov. Prikažemo ga lahko tudi v algoritemski obliki. \\
\begin{algorithm}
	\caption{Baum-Welchov algoritem}
	\KwIn{}
	\KwResult{$P(O|\lambda_{konèna}) \leq \delta$, kjer je $\delta$ zahtevana velikost funkcije verjetja.}
\end{algorithm}
...
Ne poznamo analitiènega naèina, kako bi lahko ta problem rešili, vendar lahko najdemo tak $\lambda$, da lahko našo verjetnost $P(O|\lambda)$ lokalno maksimiziramo.\\
%Opiši BW
