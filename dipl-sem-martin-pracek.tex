...
Naj bo $(\Omega,\mathcal{F},\mathbb{P},(\mathcal{F}_s)_{s \geq 0 })$ verjetnostni prostor s filtracijo za neko urejeno množico $I$. Naj velja, da je $(S,\mathcal{S})-$merljiv prostor na katerem obstaja merljiv sluèajni proces $X=(X_t){t\in I}$, ki je prilagojen na filtracijo.\\
