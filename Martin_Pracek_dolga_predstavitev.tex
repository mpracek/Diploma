...
\begin{frame} 
\begin{itemize}
	\item Prediktivno modeliranje
	\item Verjetnostna napoved
\end{itemize}	
\begin{table}
	\begin{tabular}{lllll}
		\cline{1-3}
...
\end{itemize}
	\end{columns}
\begin{columns}
	\includegraphics[scale=0.3]{slike/gen}
\end{columns}
\end{frame}
...
\end{columns}
\begin{columns}
	\includegraphics[scale=0.3]{slike/delnica}
\end{columns}
...
\includegraphics[scale=0.5]{slike/skew}
\end{frame}
\begin{frame} 
\begin{columns}
	\column{0.5\textwidth}
...
\begin{frame}
\includegraphics[scale=0.23]{slike/celota}
\includegraphics[scale=0.23]{slike/polovica}
\end{frame}
